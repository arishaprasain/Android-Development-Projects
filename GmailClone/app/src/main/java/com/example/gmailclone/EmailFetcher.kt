...
class EmailFetcher {
    companion object {
        ...
        val title = "Welcome to the jungle!"
        val summary = "Welcome ! We're excited to have you join us and learn how to develop Android apps using Kotlin. Here are some tips to get started."
